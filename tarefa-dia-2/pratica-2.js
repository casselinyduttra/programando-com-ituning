...
// Escreva depois dos ': IF ok ' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 
if (a == 10) {
...
// Escreva depois dos ': ELSE ok' a não é maior que 10, é igual a 10' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 
if (a > 10) {
...
// Escreva depois dos ': ELSE porque o sinal é de menor ' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 
if (10 <= a) {
...
// Escreva depois dos ': NAO SEI' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 
if (d[0] == 1) {
...
// Escreva depois dos ': Não sei ' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 
if (d[1] == 1) {
